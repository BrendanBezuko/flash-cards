      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <button
          ...
          className={`p-2 rounded ${
            shuffle ? "bg-red-500 text-white" : "bg-green-500 text-white"
          }`}
        >
  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center flex-grow">
        <div
          className="bg-gray-100 shadow-lg rounded-lg p-6 text-center md:w-[500px] md:h-[500px] flex flex-col justify-center items-center my-12"
          onClick={handleShowAnswer}
        >
          <div
            className={`transition-transform duration-500 transform ${
              showAnswer ? "scale-100" : "scale-90"
            }`}
          >
            ...
            {showAnswer && <p className="text-xl">{currentFlashcard.answer}</p>}
          </div>
          {showAnswer && (
